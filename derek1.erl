...
-export([hello_world/0,preschool/0]).
-export([get_id/1]).
-export([triple/1]).
%hello_world() -> io:fwrite("hello, world\n").
 
%cd("/Users/derekbanas/Documents/workspace/ErlangTut/src").
 
%c(erlangtut).
%erlangtut:hello_world().
 
%cd("C:\Users\derekbanas\workspace\ErlangTut\src").
...
% We compile to byte code like this c(tut).
